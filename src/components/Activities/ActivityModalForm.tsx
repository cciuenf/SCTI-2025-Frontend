...
import {
  type ActivityCreationDataI,
  activityCreationSchema,
...
const ActivityModalForm: React.FC<{
  ...
  const fields: FieldConfig<ActivityCreationDataI>[] = [
    ...
    },
    {
      ...
      placeholder: "Informe o tipo do evento",
    },
    {
      name: "description",
      label: "Descrição",
    ...
    },
    {
      name: "level",
      label: "Dificuldade",
      placeholder: "Selecione o nível da atividade",
      type: "select" as const,
      options: [
        { label: "Não se aplica", value: "none" },
