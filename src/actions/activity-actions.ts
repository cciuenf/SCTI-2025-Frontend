...
export async function handleGetAllEventActivities(slug: string) {
  return actionRequest<null, ActivityWithSlotResponseI[]>(
...
export async function handleCreateActivity(
  data: ActivityCreationDataI,
  slug: string
) {
  return actionRequest<ActivityCreationDataI, ActivityResponseI>(
...
export async function handleDeleteActivity(
  ...
  return actionRequest<{ activity_id: string }, string>(
    `/events/${slug}/activity`,
    {
      method: "DELETE",
      body: data,
...
export async function handleUpdateActivity(
  ...
  return actionRequest<
    Partial<ActivityCreationDataI> & { activity_id: string },
    ActivityResponseI
  >(`/events/${slug}/activity`, {
    method: "PATCH",
...
export async function handleRegisterFromActivity(
  ...
  return actionRequest<
    ...
    ActivityResponseI
  >(`/events/${slug}/activity/${activityType}`, {
    method: "POST",
...
export async function handleUnregisterFromActivity(
  ...
  const activityType = data.is_standalone
    ? "unregister-standalone"
    : "unregister";
  return actionRequest<
    { activity_id: string; user_id: string },
    ActivityResponseI
...
export async function handleGetRegisteredUsersInActivity(
  data: { id: string },
  slug: string
) {
...
export async function handleGetUsersWhoParticipateInActivity(
  data: { id: string },
  slug: string
) {
  return actionRequest<null, ActivityRegistrationI[]>(
